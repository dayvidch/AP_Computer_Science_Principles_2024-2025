...
colors_list = ["black", "blue", "orange", "green", "red", "yellow"]
...
'''leaderboard function imported from the document'''
...
def manage_leaderboard():
  ...
  if (len(leader_scores_list) < 5 or score >= leader_scores_list[4]):
    ...
    lb.draw_leaderboard(True, leader_names_list, leader_scores_list, object1, score)

  else:
    lb.draw_leaderboard(False, leader_names_list, leader_scores_list, object1, score)
